...
class Language {
	...
	public static function load() {
		...
		$langDir = apply_filters(
			sprintf( '%s_languages_directory', 'give-divi' ), // phpcs:ignore WordPress.NamingConventions.ValidHookName.UseUnderscores, WordPress.NamingConventions.ValidHookName.NotLowercase
